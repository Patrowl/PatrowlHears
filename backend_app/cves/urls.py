...
urlpatterns = [
    ...
    path('cwes/list', apis.get_cwes, name='get_cwes'),
    ...
    path('cves/async/from/<from_year>', apis.sync_cves_fromyear_async, name='sync_cves_fromyear_async'),
    path('cves/async/<year>', apis.sync_cves_atyear_async, name='sync_cves_atyear_async'),
    # path('cves/asyncbis/<year>', apis.sync_cves_atyear_async_bis, name='sync_cves_atyear_async_bis'),
