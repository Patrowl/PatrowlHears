      ...
      <v-card>
        ...
        <v-card-text>
          <v-form ref="form-vuln-sendmail">
            ...
            <v-btn color="success" @click="sendEmailVuln(selected_vuln_id)">Send</v-btn>
...
export default {
  ...
  methods: {
    ...
    getVulns(page, itemsPerPage, sortBy, sortDesc, extra_filters) {
      ...
      this.$api.get('/api/vulns/?limit='+itemsPerPage+'&page='+page+'&search='+this.appsearch+sorted_by+extra_filters).then(res => {
        this.vulns = res.data;
        this.loading_vulns = false;
        return this.vulns;
      }).catch(e => {
    ...
    getExploits(page, itemsPerPage, sortBy, sortDesc, extra_filters) {
      ...
      this.$api.get('/api/exploits/?limit='+itemsPerPage+'&page='+page+'&search='+this.appsearch+sorted_by+extra_filters).then(res => {
    ...
    getThreats(page, itemsPerPage, sortBy, sortDesc, extra_filters) {
      ...
      this.$api.get('/api/threats/?limit='+itemsPerPage+'&page='+page+'&search='+this.appsearch+sorted_by+extra_filters).then(res => {
