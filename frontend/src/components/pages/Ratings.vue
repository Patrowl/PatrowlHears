...
export default {
  ...
  computed: {
    rating_vector() {
      ...
      // console.log(this.vuln_score)
      // console.log(this.threat_score)
      // console.log(this.asset_score)
  ...
  methods: {
    init_vector(vector) {
      ...
      for(let i = 0; i < metrics.length; i++) {
        ...
        m[0] == 'EX' ? this.threat.exploit_age = moment().subtract(m[1], "days").toISOString(true).substr(0, 10):'';
